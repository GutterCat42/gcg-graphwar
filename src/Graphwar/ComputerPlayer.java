...
{		
  ...
  //  }
	...
	{		
		...
		generationLoop:
		for(int k=0; processingFunction && graphwar.getGameData().getGameState()==Constants.GAME && ((k<numGenerations && (graphwar.getGameData().getRemainingTime()) > 110000) || (over9000)); k++)
		{
	    	...
	    	{   
	    		...
	    		if((graphwar.getGameData().getRemainingTime()) < 110000 && !over9000)
	    		{
	    	...
	    	if(over9000)
	    	{
	    		if(myTurn && (graphwar.getGameData().getRemainingTime()) < 110000)
	    		{
